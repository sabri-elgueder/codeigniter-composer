...
class Installer
{
    ...
    private static function showMessage(Event $event = null)
    {
        ...
        $io->write("        _____         _                 _                                                 ");
        $io->write("       /  ___|       | |               (_)                                                ");
        $io->write("       \ `--.   __ _ | |_   ___   _ __  _  _ __    ___   _ __       ___   ___   _ __ ___  ");
        $io->write("        `--. \ / _` || __| / _ \ | '__|| || '_ \  / _ \ | '_ \     / __| / _ \ | '_ ` _ \ ");
        $io->write("       /\__/ /| (_| || |_ | (_) || |   | || |_) || (_) || |_) | _ | (__ | (_) || | | | | |");
        $io->write("       \____/  \__,_| \__| \___/ |_|   |_|| .__/  \___/ | .__/ (_) \___| \___/ |_| |_| |_|");
        $io->write("                                          | |           | |                               ");
        $io->write("                                          |_|           |_|                               ");
        $io->write(" ");
